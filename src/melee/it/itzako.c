...
Item_GObj* it_8027CC88(Item_GObj* item_gobj_arg)
{
    ...
    if ((gm_IsCurrently1PMode() != 0) && (HSD_Randi(it_804D6D40->x14) == 0)) {
        if (grLib_801C9E40() == 0) {
            ...
            if (var_r30 != -1) {
                temp_r3 = tyDisplay_8031C354(
                    var_r30, sp1C, (s32) ARRAY_SIZE(sp1C), 0x63);
                temp_r3_2 = temp_r3;
                if (temp_r3 < (s32) ARRAY_SIZE(sp1C)) {
                    temp_r3_2 += tyDisplay_8031C354(
                        var_r30, &sp1C[temp_r3],
                        (s32) ARRAY_SIZE(sp1C) - temp_r3, 2);
                }
                if (temp_r3_2 != 0) {
